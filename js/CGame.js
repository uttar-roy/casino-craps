function CGame(oData) {
        ...
        if (iRand >= iWinOccurence) {
            ...
            if (_iContRolling > _iMaxNumRolling) {
                ...
                do {
                    ...
                    // var aDices = (serverRequests.mode == 'online') ?
                    //     serverRequests._generateRandomDices() :
                    //     this._generateRandomDices();
    ...
    this.onRoll = function() {
        ...
        if (serverRequests.mode === 'offline') {} else {
            ...
            // response = roundDecimal(response, 1);
    ...
    this.onClearAllBets = function() {
        ...
        if (_iState === STATE_GAME_COME_POINT) {
            console.log("onClearAllBets STATE_GAME_COME_POINT");
            ...
            console.log("onClearAllBets else");
