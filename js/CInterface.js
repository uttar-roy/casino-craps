function CInterface() {
    ...
    this.setMoney = function(iMoney) {
        // _oMoneyAmountText.refreshText(iMoney.toFixed(2) + languageService.serverCurrency("currencySymbol"));
    ...
    this.setCurBet = function(iCurBet) {
        // _oBetAmountText.refreshText(iCurBet.toFixed(2) + languageService.serverCurrency("currencySymbol"));
